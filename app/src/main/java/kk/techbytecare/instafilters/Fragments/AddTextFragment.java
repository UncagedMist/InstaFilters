 ...
 */
public class AddTextFragment extends BottomSheetDialogFragment implements ColorAdapterListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        btn_done.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                listener.onAddTextButtonClicked(edt_add_text.getText().toString().trim(),colorSelected);
            }
        });
